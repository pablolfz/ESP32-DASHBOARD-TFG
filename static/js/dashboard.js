...
function resetZoom(chartId) {
    ...
    if (chart) {
        chart.resetZoom();
        fetchAndDrawHistoricalData(true); // Recarga para centrar en el último punto
    }
}
...
function jumpToTime(chartId, datetimeId) {
    ...
    const range = 3600000; // 1 hora
    const targetTimeMs = targetDate.getTime();
    
    // Buscar el punto de datos más cercano (similar a la lógica de moveTime)
    // El eje X se centra en el punto objetivo
    ...
    chartInstance = new Chart(ctx, {
        ...
        options: {
            ...
            scales: {
                x: {
                    ...
                    ticks: {
                        autoSkip: false,  
                        maxTicksLimit: 200, 
                        maxRotation: 30, // Rotación de 30 grados
                        minRotation: 30, // Rotación de 30 grados
                        font: {
                            size: 12
                        },
                        padding: 10,
            ...
            plugins: {
                ...
                // ⭐ Configuración del Plugin de Zoom (Solo para Pan y Desplazamiento) ⭐
                zoom: {
                    pan: {
                        enabled: true,
                        mode: 'x',
...
// ... (Resto de funciones: updateSignalIcon, fetchAndDrawHistoricalData, tryDrawEmptyCharts) ...
