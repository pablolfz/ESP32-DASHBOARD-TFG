...
# URL de tu Realtime Database (asegúrate de que termine en .json)
...
def download_csv():
    try:
        ...
        res.headers["Content-Disposition"] = f"attachment; filename=log_30dias_{datetime.now().strftime('%Y%md')}.csv"
